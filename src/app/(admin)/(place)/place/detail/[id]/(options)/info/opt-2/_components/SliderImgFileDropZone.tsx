...
const SliderImgFileDropZone = () => {
  const { sliderImgsSrc, setSliderImgsSrc } = hook.usePlaceInfoOpt2Store();
  ...
  const handleFileUpload = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const newImages: string[] = [...sliderImgsSrc];
    ...
    <div className="p-6.5">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center space-y-3">
          ...
          <p className="mt-1.5">
            16:9 비율로 최소 가로길이 최소 495px 이상의 이미지를 업로드해주세요.
          </p>
        </div>
      </div>
    </div>
...
export default SliderImgFileDropZone;

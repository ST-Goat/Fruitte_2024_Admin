...
import { useDeleteIntroOpt2 } from "@/features/place/queries/intro";
...
const UpdateDropdown: React.FC<{
  ...
  const { mutate: deleteContent, isPending: isDeleting } = useDeleteIntroOpt2(
    placeId,
    contentId,
  );
  ...
  return (
    <div>
      ...
      >
        <Link
          href={`/place/detail/${pathname?.split("/")[3]}/intro/opt-2/${contentId}/update`}

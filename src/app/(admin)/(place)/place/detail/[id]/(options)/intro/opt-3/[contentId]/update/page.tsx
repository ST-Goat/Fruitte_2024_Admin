...
import {
  useGetIntroOpt3Detail,
  useUpdateIntroOpt3,
} from "@/features/place/queries/intro";
import { Opt3Info } from "@/features/place/types/intro/api";
...
const Opt2CreatePage = ({ params }: Props) => {
  ...
  } = useGetIntroOpt3Detail(params.id, params.contentId);
  const { mutate: update, isPending: isUpdating } = useUpdateIntroOpt3(
    data as Opt3Info,
  );
  ...
  return (
    <>
      <PlaceDetailLayout>
        <Breadcrumb pageName={`"프루떼 추천 즐기는 방법" 컨텐츠 수정`} />

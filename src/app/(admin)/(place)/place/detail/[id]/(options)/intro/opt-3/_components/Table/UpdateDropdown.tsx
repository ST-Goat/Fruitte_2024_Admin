...
import { useDeleteIntroOpt3 } from "@/features/place/queries/intro";
...
const UpdateDropdown: React.FC<{
  ...
  const { mutate: deleteContent, isPending: isDeleting } = useDeleteIntroOpt3(
    placeId,
    contentId,
  );
  ...
  return (
    <div>
      ...
      >
        <Link
          href={`/place/detail/${pathname?.split("/")[3]}/intro/opt-3/${contentId}/update`}

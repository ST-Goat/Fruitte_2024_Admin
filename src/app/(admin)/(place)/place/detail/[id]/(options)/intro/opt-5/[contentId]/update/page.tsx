...
import { Opt5Info } from "@/features/place/types/intro/api";
...
const Opt2CreatePage = ({ params }: Props) => {
  ...
  } = query.useGetIntroOpt5Detail(params.id, params.contentId);
  const { mutate: update, isPending: isUpdating } = query.useUpdateIntroOpt5(
    data as Opt5Info,
  );
  ...
  return (
    <>
      <PlaceDetailLayout>
        <Breadcrumb pageName={`"프로그램 VIEW" 컨텐츠 수정`} />

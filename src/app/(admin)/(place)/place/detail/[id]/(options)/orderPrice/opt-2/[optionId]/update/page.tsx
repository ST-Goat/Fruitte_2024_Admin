...
import { Opt2Info } from "@/features/place/types/orderPrice/api";
...
const Opt2CreatePage = ({ params }: Props) => {
  ...
  } = query.useGetOrderPriceOpt2Detail(params.id, params.optionId);

  const { mutate: update, isPending: isUpdating } =
    query.useUpdateOrderPriceOpt2(data as Opt2Info);
  ...
  return (
    <>
      <PlaceDetailLayout>
        <Breadcrumb pageName={`"가격 및 상품 정보" 옵션 수정`} />

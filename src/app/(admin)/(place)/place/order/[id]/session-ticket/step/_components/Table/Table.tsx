...
import { useGetSessionTicketsBySessionId } from "@/features/place/queries/session-ticket";
import Loader from "@/components/common/Loader";

const Table = ({ placeId }: { placeId: string }) => {
  const { info } = useSessionTicketStepStore();
  const { isLoading, isSuccess } = useGetSessionTicketsBySessionId();
